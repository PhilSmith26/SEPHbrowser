# Table module #5 for SEPH standard work week for salaried employees by ind and prov, NSA
...
mt05Server <- function(id) {
  moduleServer(id,function(input,output,session) {
    ...
    expr <- reactive({
      Make_tablM05(Geo2(),type1(),month1(),month2())
    })
