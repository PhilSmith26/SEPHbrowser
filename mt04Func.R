# Table module #4 for SEPH AHE for salaried employees by ind and prov, NSA
...
mt04Server <- function(id) {
  moduleServer(id,function(input,output,session) {
    ...
    expr <- reactive({
      Make_tablM04(Geo2(),type1(),month1(),month2())
    })
