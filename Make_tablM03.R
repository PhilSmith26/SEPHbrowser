# Make_tablM03() function - SEPH AHE by industry and province
# August 2, 2021
...
#===============================================================================
Make_tablM03 <- function(Geo1,Ovr1,type,month1,month2) {
  #browser()
  ...
  gt_tbl <- tab_header(gt_tbl,
      title=md(paste0("**","Table ",TS[[3]]$Bnum,"<br>",TS[[3]]$Titl,"**")),
      subtitle=md(paste0(subtitle,"<br><br>")))
  gt_tbl <- tab_source_note(gt_tbl,
      source_note=md(TS[[3]]$Ftnt)) 
