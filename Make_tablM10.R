# Make_tablM10() function - SEPH employment or AWE by ind, by prov, SA
# August 3, 2021
...
#===============================================================================
Make_tablM10 <- function(Geo1,Est1,type,month1,month2) {
  #browser()
  ...
  if (Est1=="Employment for all employees" & type==1) {dec1 <- 0}                                
  else {dec1 <- 2}
  title <- Est1
  subtitle1 <- paste0(Geo1,"<br>")
  subtitle <- case_when(
        type==1 ~ paste0(subtitle1,
          TS[[10]]$Seas,"<br><br>"),
        type==2 ~ paste0(subtitle1,"Indexed to ",colnam2[1]," = 100<br>",
          TS[[10]]$Seas,"<br><br>"),
        type==3 ~ paste0(subtitle1,"One-month percentage change<br>",
          TS[[10]]$Seas,"<br><br>"),
        type==4 ~ paste0(subtitle1,"Twelve-month percentage change<br>",
          TS[[10]]$Seas,"<br><br>")
  )
  ...
  gt_tbl <- tab_header(gt_tbl,
      title=md(paste0("**","Table ",TS[[10]]$Bnum,"<br>",title,"**")),
      subtitle=md(paste0(subtitle,"<br><br>")))
  gt_tbl <- tab_source_note(gt_tbl,
      source_note=md(TS[[10]]$Ftnt)) 
