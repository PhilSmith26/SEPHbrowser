# Table module #1 for SEPH employment by ind and prov, NSA
...
mt01Server <- function(id) {
  moduleServer(id,function(input,output,session) {
    ...
    expr <- reactive({
      Make_tablM01(Geo2(),Kin2(),type1(),month1(),month2())
    })
