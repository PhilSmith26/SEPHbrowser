# Make_tablM04() function - SEPH AHE for salaried empl by industry and province
# August 2, 2021; improved August 10, 2021

Make_tablM04 <- function(Geo1,type,month1,month2) {
  ...
  gt_tbl <- tab_header(gt_tbl,
      title=md(paste0("**","Table ",TS[[4]]$Bnum,"<br>",TS[[4]]$Titl,"**")),
      subtitle=md(paste0(subtitle,"<br><br>")))
  gt_tbl <- tab_source_note(gt_tbl,
      source_note=md(TS[[4]]$Ftnt)) 
